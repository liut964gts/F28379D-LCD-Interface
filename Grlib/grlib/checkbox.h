...
typedef struct Graphics_CheckBox
{
	...
	uint16_t gap;			   /*!< draws checbox with checkbox selected in pixels*/
	...
	uint16_t numbOfChar;		   /*!< Number of characters in checkbox message */
	const Graphics_Font *font; /*!< Font for text to be displayed in button */
	int16_t *text;			   /*!< Text to be displayed in button */
} Graphics_CheckBox;
