...
//
//*****************************************************************************
uint16_t Graphics_getFontBaseline(const Graphics_Font *font)
{
...
//
//*****************************************************************************
uint16_t Graphics_getFontHeight(const Graphics_Font *font)
{
	return font->height;
}
...
//
//*****************************************************************************
uint16_t Graphics_getFontMaxWidth(const Graphics_Font *font)
{
