...
int32_t Graphics_getStringWidth(const Graphics_Context *context,
		const int16_t *string, int32_t  length)
{
    const uint16_t *offset;
    const uint16_t *data;
    uint16_t first, last, absent;
    int32_t  width;
...
//
//*****************************************************************************
void Graphics_drawString(const Graphics_Context *context, int16_t *string,
...
//
//*****************************************************************************
uint16_t Graphics_getStringBaseline(const Graphics_Context *context)
{
...
//
//*****************************************************************************
uint16_t Graphics_getStringHeight(const Graphics_Context *context)
{
...
//
//*****************************************************************************
uint16_t Graphics_getStringMaxWidth(const Graphics_Context *context)
{
